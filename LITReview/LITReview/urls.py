...
urlpatterns = [
    ...
    path('posts/<str:post_type>/<int:post_id>/alter', views.alter_post, name='alter_post'),
    path('posts/<str:post_type>/<int:post_id>/del', views.delete_post, name='delete_post'),
