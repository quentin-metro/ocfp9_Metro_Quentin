...
urlpatterns = [
    ...
    path('review/<int:ticket_id>', views.review_create, name='review_to'),
    path('review/', views.review_ticket_create, name='review_ticket'),
    ...
    path('follows/<int:follow_id>', views.unfollow, name='unfollow')
